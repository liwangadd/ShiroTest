...
<%@taglib prefix="leefn" uri="http://github.com/zhangkaitao/tags/zhang-functions" %>
...
<table class="table">
    ...
    <c:forEach items="${userList}" var="user">
        <tr>
            <td>${user.username}</td>
            <td>${leefn:organizationName(user.organizationId)}</td>
            <td>${leefn:roleNames(user.roleIds)}</td>
            <td>
